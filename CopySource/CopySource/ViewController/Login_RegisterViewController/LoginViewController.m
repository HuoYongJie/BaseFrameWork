...
- (IBAction)loginButtonDidClicked:(UIButton *)sender
{
    ...
    [AppDelegate shareAppDelegate].rootTabbar.selectedIndex = 0;

   BaseNavigationController *personcenterNav = (BaseNavigationController *)[AppDelegate shareAppDelegate].rootTabbar.viewControllers[2];
    
        [self dismissViewControllerAnimated:YES completion:^{
            [personcenterNav popToRootViewControllerAnimated:NO];
        }];
    return;
